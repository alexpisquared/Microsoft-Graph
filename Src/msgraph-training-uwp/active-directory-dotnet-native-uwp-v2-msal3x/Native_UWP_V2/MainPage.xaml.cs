  ...
  public sealed partial class MainPage : Page
  {
    ...
    private async void CallGraphButton_Click(object sender, RoutedEventArgs e)
    {
      try
      {
        ...
        Windows.UI.Xaml.Media.Imaging.BitmapImage bmp = null;
        ...
        if (profilePhoto != null)
        {
          ...
          bmp.SetSource(memoryStream.AsRandomAccessStream());
        }
    ...
    private async Task<string> SignInUserAndGetTokenUsingMSAL(string[] scopes)
    {
      ...
      string redirectUri = $"memoryStream-appx-web://microsoft.aad.brokerplugin/{sid}";
