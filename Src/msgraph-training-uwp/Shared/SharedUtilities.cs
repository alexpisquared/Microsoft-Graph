...
public static class SharedUtilities
{
  ...
  static readonly Lazy<bool> s_isMono = new(() => Type.GetType("Mono.Runtime") != null);

  static string s_processName = null;
  static int s_processId = default;
  ...
  internal static bool IsMonoPlatform() => s_isMono.Value;
  ...
  static string GetUserHomeDirOnUnix()
  {
    ...
    {
      return SharedUtilities.IsLinuxPlatform()
        ? LinuxNativeMethods.getuid() == LinuxNativeMethods.RootUserId
                      ? "/root"
                      : !string.IsNullOrEmpty(username) ? Path.Combine("/home", username) : null
        : throw new NotSupportedException();
    }
  }
}
